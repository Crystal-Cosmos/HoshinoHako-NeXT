...
![iris.gif](https://s2.loli.net/2023/08/30/YtuSr9Cop87NRDP.gif)

效果如图，你可以自由变更渐变速度

![irisprev.gif](https://s2.loli.net/2023/08/30/kVMbKcYZUrhzEPu.gif)

如果你需要限定Iris触发的区域只需点开Key编辑器，然后拖动下方的绿条即可，只有绿条有的地方才能触发Iris

![iriskey.gif](https://s2.loli.net/2023/08/30/kH6DzNQ8vGo5yTe.gif)

### Resonator
与Iris类似，除了可以制作单键渐变外还可以一键做一些常用灯光，如下图

![resonator.gif](https://s2.loli.net/2023/08/30/kGwdcLaEohpyDJF.gif)
...
![setresonator.gif](https://s2.loli.net/2023/08/30/tFlOPcsNmBhRS86.gif)

### Eyedrop
Eyedrop是一个灯光制作辅助插件，可以将平常需要一个一个调的内容一键化

![eyedrop.gif](https://s2.loli.net/2023/08/30/AjxOTvHC5YQU3Sk.gif)

调用方法也很简单，首先我们需要新建一个MIDI轨道，然后将其改名成Eyedrop，然后将Eyedrop放到这个轨道里，并把监听模式调成In即可

![seteyedrop.gif](https://s2.loli.net/2023/08/30/XEoflqRwS37KDHZ.gif)

之后打开Eyedrop的菜单，这个轨道就可以放一边了，你可以把它折叠掉。然后将你绘制灯光的MIDI轨道，输入调成Eyedrop这个轨道输入，输出调成Launchpad，然后开启绘制轨道的预备监听，Eyedrop就可以使用了

![seteyedrop2.gif](https://s2.loli.net/2023/08/30/Q8okRIB4YUP62rN.gif)
...
![changepalette.png](https://s2.loli.net/2023/08/30/vLPEVYe7xOqco5Q.png)

此时你的Launchpad全部的颜色都会被改变，所以仅适用于使用了同样色板的工程使用，其他工程颜色会错乱，同时你原来背的颜色值也全部不适用，要按照新的色板来制作灯光，Eyedrop也支持自定义色板，只需在设置菜单内加载即可

![eyedropcuspale.png](https://s2.loli.net/2023/08/30/AhXmcgWYCjwQKNx.png)
