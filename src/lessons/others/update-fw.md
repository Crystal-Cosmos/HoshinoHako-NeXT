...
### 如何更新？
首先你需要访问[Novation Components](/res/fwupdater#launchpad-mk3系列)
第一次打开请点击“Yes，I Agree”同意获取Cookie，其次如果浏览器提示你访问MIDI设备请允许它：
![img](/images/tutorial/components-cookies.png =800x)

![img](/images/tutorial/chrome-allow-midi.png =400x)

然后插上你的设备，他会自动识别，点击进入设置页，这时如果你的固件版本过低，Components会自动弹出窗口提醒你更新

![img](/images/tutorial/components-states.png =400x)

更新时需要你手动确认一次，他会提示你按哪个按键，按下它显示的按键即可开始升级，升级完成后Launchpad会自动重启

![img](/images/tutorial/components-update-agree.png =400x)
...
![img](/images/tutorial/lfu-sysex.png =200x)

![img](/images/tutorial/lfu-choose.png =550x)

接着根据页面显示操作即可，之后你的Launchpad会自动重启

![img](/images/tutorial/lfu-bl.png =1000x)
...
如果你无法访问官网你可以直接在星之箱下载: [跳转](/res/fwupdater#launchpad-mk2系列)

下载好后插入Launchpad，然后打开升级程序，点击确定后等待他完成升级

![img](/images/tutorial/lppromk1-updater.png =400x)

![img](/images/tutorial/lppromk1-updater-progress.png =300x)
